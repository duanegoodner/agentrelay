...
- `docs/diagram-detailed.d2` — authoritative design diagram source (D2 with ELK layout); updated every PR
- `docs/diagram-detailed.svg` — rendered detail diagram (generated by `pixi run diagram`)
...
- `docs/diagram-overview.html` — interactive overview with connector click popups (generated by `pixi run diagram`)
