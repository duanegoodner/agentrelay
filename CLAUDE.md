...
(`docs/diagram-detailed.d2`) must be a class — dataclass, enum, Protocol, or ABC. When a
...
- `docs/diagram-detailed.d2` — authoritative design diagram source (D2 with TALA layout); updated every PR
- `docs/diagram-detailed.svg` — rendered detailed diagram (generated by `pixi run diagram`)
- `docs/diagram-standard.d2` — auto-generated standard view: public types, collapsed impls (do not edit)
- `docs/diagram-standard.svg` — rendered standard diagram (generated by `pixi run diagram`)
- `docs/diagram-no-private.d2` — auto-generated: public types with full impl detail (do not edit)
- `docs/diagram-no-impl.d2` — auto-generated: all types with collapsed impls (do not edit)
