...
- `docs/diagrams/uml/diagram-standard.d2` — auto-generated standard view: public types, collapsed impls (do not edit)
- `docs/diagrams/uml/diagram-standard.svg` — rendered standard diagram (generated by `pixi run diagram`)
- `docs/diagrams/uml/diagram-no-private.d2` — auto-generated: public types with full impl detail (do not edit)
- `docs/diagrams/uml/diagram-no-impl.d2` — auto-generated: all types with collapsed impls (do not edit)
