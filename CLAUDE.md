...
- Update `docs/diagram.d2` and re-render `docs/diagram.svg` (`pixi run diagram`)
  in every PR that touches `src/agentrelay/`

## Coding conventions

**Public API surfaces use classes.** Every type that appears in the design diagram
(`docs/diagram.d2`) must be a class — dataclass, enum, Protocol, or ABC. When a
...
- `docs/diagram.d2` — authoritative design diagram source (D2 with ELK layout); updated every PR
- `docs/diagram.svg` — rendered detail diagram (generated by `pixi run diagram`)
- `docs/diagram-overview.d2` — auto-generated package-level overview (generated by `tools/generate_overview.py`)
- `docs/diagram-overview.svg` — rendered overview SVG (generated by `pixi run diagram`)
- `docs/diagram-overview.html` — interactive overview with click-to-open graphical popups (generated by `pixi run diagram`)
- `docs/pkg-detail/*.d2` / `*.svg` — per-package D2 files and rendered SVGs (generated by `pixi run diagram`)
- `docs/diagram-midlevel.d2` — auto-generated mid-level diagram: full internals, collapsed cross-package arrows (generated by `tools/generate_overview.py --mode midlevel`)
- `docs/diagram-midlevel.svg` — rendered mid-level SVG (generated by `pixi run diagram`)
- `docs/diagram-midlevel.html` — interactive mid-level with JS arrow tooltips (generated by `pixi run diagram`)
