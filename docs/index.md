...
- Core architecture types in `src/agentrelay/` (`TaskGraph`, `TaskGraphBuilder`, `Task`, `TaskRuntime`, `Agent`, `AgentEnvironment`)
- A runnable prototype orchestrator in `src/agentrelay/prototypes/v01/`
- Test coverage for both layers (`493` tests collected)
